...
<div style="background: #83cee7;" id="login" class="login">
<?php
...
<form action="login.php" method="post">
	<?php if (isset($_GET['error'])) { ?>
     		<p class="btn btn-danger"><?php echo $_GET['error']; ?></p>
     	<?php } ?>

			<font style=" font:bold 44px 'Helvetica'; color:#fff; -webkit-text-stroke-width: 2px; -webkit-text-stroke-color: black;">
				<center> Welcome to <br> MR. Vape Shop </center></font>
		<br>
